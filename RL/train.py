...
import RL.env_wrapper as env_wrapper
import RL.utils as utils
from RL.curl_sac import CurlSacAgent, RadSacAgent
...
def parse_args(_args=None):
    ...
    # environment
    parser.add_argument('--domain_name', default='fill_in_domain_name!')
...
def main(_args=None):
    ...
    print("args.domain_name", args.domain_name)
